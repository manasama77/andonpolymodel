					...
					<div class="section col-xs-12">
						...
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<a class="nav-item nav-link" data-toggle="tab" href="#nav-kikukawa" role="tab" aria-controls="nav-kikukawa" style="display:none">Kikukawa</a>
								<a class="nav-item nav-link active" data-toggle="tab" href="#nav-ncb3" role="tab" aria-controls="nav-ncb3" aria-selected="true">NCB3</a>
