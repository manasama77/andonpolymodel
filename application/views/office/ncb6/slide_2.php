...
<div class="row p-2">
	<!-- <div class="col-12 text-center" id="kikukawaParent">
		<div id="kikukawa" class="chartShow" style="width: 100%; height: 530px;"></div>
	</div> -->
	<!-- <div class="col-12 p-2" id="ncb3Parent">
		<div id="ncb3" class="chartShow" style="width: 100%; height: 530px;"></div>
	</div> -->
	<div class="col-12 p-2" id="ncb6Parent">
		<div id="ncb6" class="chartShow" style="width: 100%; height: 530px;"></div>
	</div>
</div>